...
export interface FormattingOperation {
  type: 'cell-cleaned' | 'structure-fixed' | 'header-restored' | 'markdown-processed';
  description: string;
...
export interface TableIssue {
  type: 'missing-headers' | 'merged-cells' | 'inconsistent-columns' | 'text-artifacts' | 'encoding-issues';
